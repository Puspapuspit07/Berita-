    ...
    <html lang="en">
      <body className={inter.className}>
        <div className="max-w-3xl mx-auto text-slate-800">
          <header className="p-6 border-b flex items-center justify-between bg-red-600 rounded-bl-lg rounded br-lg">
            <Link className="text-2xl font-bold text-white" href={'/'}>BERITA</Link>
